...
def generate_email_html(full_name, recipient_email=None, subject=None, custom_html=None):
    ...
    # Tracking elements
    event_url = "https://www.eventbrite.com/e/business-innovation-expo-2026-book-your-visitor-ticket-at-premier-show-tickets-1649957239519?aff=oddtdtcreator"
...
<p style="margin-top:25px; font-size:14px; font-weight:bold;">
  ...
  <a href="mailto:eugene@businessinnovationexpo.com" style="color:#D7262F; font-weight:bold;">eugene@businessinnovationexpo.com</a><br/>
  (+44) 2034517166
</p>
...
def send_email(sender_email, sender_password, row, subject, custom_html):
    try:
        server = smtplib.SMTP("mail.businessinnovationexpo.com", 587)
        server.starttls()
        ...
        try:
            imap = imaplib.IMAP4_SSL("mail.businessinnovationexpo.com")
...
sender_email = st.text_input("Sender Email", value="eugene@businessinnovationexpo.com")
